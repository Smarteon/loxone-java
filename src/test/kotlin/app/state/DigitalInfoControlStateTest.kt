...
class DigitalInfoControlStateTest {
    ...
    fun `should process value event`() {
        ...
        digitalInfoControlState.accept(ValueEvent(LoxoneUuid("0f869a64-028d-0cc2-ffffd4c75dbaf53d"), 5.25)) // not for this control
        expectThrows<IllegalArgumentException> {
            digitalInfoControlState.accept(ValueEvent(LoxoneUuid("0f869a64-028d-0cc2-ffffd4c75dbaf53c"), 5.25)) // for this control
        }
