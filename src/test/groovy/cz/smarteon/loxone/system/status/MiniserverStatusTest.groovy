...
class MiniserverStatusTest extends Specification implements SerializationSupport {
    ...
    def "should deserialize"() {
        ...
        ms.extensions[9].serialNumber == '17d8060c'
        ms.extensions[10].serialNumber == '16d80173'
        ms.extensions[11] instanceof UnrecognizedExtension
        ms.extensions[11].name == 'Some Future Extension'
